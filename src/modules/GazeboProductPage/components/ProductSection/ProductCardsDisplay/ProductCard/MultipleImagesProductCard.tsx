  ...
  return (
    <div className="relative p-8 md:p-10 lg:py-16 lg:px-28 flex-[3] bg-white">
      <div className="h-full flex items-center">
        <div className="hidden lg:flex w-10 h-full items-center shrink-0">
          <ProductNavButton
        ...
        <div className="w-full flex flex-col items-center gap-8">
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="max-w-[400px] w-full flex justify-between lg:justify-center">
              <div className={clsx('lg:hidden w-6 h-6', !isLeftNavDisabled && 'animate-slide')}>
                <ProductNavButton
                  onClick={() => setCurrImgIndex(currImageIndex - 1)}
                  type="left"
                  isDisabled={isLeftNavDisabled}
              ...
              <div className={clsx('lg:hidden w-6 h-6', !isRightNavDisabled && 'animate-slide')}>
                <ProductNavButton
                  type="right"
                  onClick={() => setCurrImgIndex(currImageIndex + 1)}
